...
/// Adds pattern-matching-related methods to [ForgotPBody].
extension ForgotPBodyPatterns on ForgotPBody {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ForgotPBody value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ForgotPBody() when $default != null:
    ...
    switch (_that) {
      case _ForgotPBody() when $default != null:
        return $default(_that.shortName, _that.userId, _that.answerOne,
            _that.passwordRe, _that.passwordOld, _that.passwordNew);
      case _:
        return orElse();
    }
  }
...
class _ForgotPBody implements ForgotPBody {
  const _ForgotPBody(
      ...
      @JsonKey(name: "answerone") this.answerOne,
