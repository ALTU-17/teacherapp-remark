...
/// Adds pattern-matching-related methods to [LeaveAppBody].
extension LeaveAppBodyPatterns on LeaveAppBody {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LeaveAppBody value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _LeaveAppBody() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _LeaveAppBody() when $default != null:
        return $default(_that.acdYr, _that.staffId, _that.shortName);
      case _:
        return orElse();
    }
  }
