...
class LessonPlanData {
  ...
  LessonPlanData copyWith({
    ...
    return LessonPlanData(
      ...
      unqId: unqId ?? this.unqId,
      lesPlnTempId: lesPlnTempId ?? this.lesPlnTempId,
      classId: classId ?? this.classId,
      sectionId: sectionId ?? this.sectionId,
      subjectId: subjectId ?? this.subjectId,
      chapterId: chapterId ?? this.chapterId,
      noOfPeriods: noOfPeriods ?? this.noOfPeriods,
      weekDate: weekDate ?? this.weekDate,
      regId: regId ?? this.regId,
      academicYr: academicYr ?? this.academicYr,
